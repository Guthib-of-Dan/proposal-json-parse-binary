...
────────────────────────────────────────────────────────────────────
  ...
  ASCII (Latin-1 path)        ███░░░░░░░░░░░░░░░░░░░░░░░░░  1042.722 ms
  Mixed (UTF-16 upgrade)      ██████████████████░░░░░░░░░░  6579.911 ms  6.31× slower


  2) heap: 25MB cap
  ASCII (Latin-1 path)        ███████░░░░░░░░░░░░░░░░░░░░░  2576.197 ms
  Mixed (UTF-16 upgrade)      ███████████████████████░░░░░  8157.605 ms  3.17× slower

  Scale: 10,000 ms. Fixed across runs for comparison.
...
────────────────────────────────────────────────────────────────────
  1) heap: unconstrained
  ASCII  heap before      4.4 MB
  ASCII  heap at exit     3.1 MB
  ASCII  string retained  ~0 MB

  Mixed  heap before      3.1 MB
  Mixed  heap at exit     113.1 MB
  Mixed  string retained  110 MB (!)
  ··································································
  ASCII  peak heap            █░░░░░░░░░░░░░░░░░░░░░░░░░░░   3.100 ms  3.1 MB
  Mixed  peak heap            █████████████████████████░░░  113.100 ms  113.1 MB
  ...
  Mixed  heap before      3.1 MB
  Mixed  heap at exit     23.1 MB
  Mixed  string retained  20 MB
  ··································································
  ASCII  peak heap            █░░░░░░░░░░░░░░░░░░░░░░░░░░░   3.100 ms  3.1 MB
  Mixed  peak heap            █████░░░░░░░░░░░░░░░░░░░░░░░  23.100 ms  23.1 MB
...
────────────────────────────────────────────────────────────────────
  1) heap: unconstrained
  ASCII  heap after GC    3.1 MB
  ASCII  freed by GC      0 MB

  Mixed  heap after GC    13.1 MB
  Mixed  freed by GC      100 MB
  ...
  Mixed  heap after GC    13.1 MB
  Mixed  freed by GC      10 MBp

  global.gc() is never called in a production server.
  Under sustained load the 110 MB retained per request
  accumulates until V8 is forced into a stop-the-world collection.

────────────────────────────────────────────────────────────────────
  Summary
────────────────────────────────────────────────────────────────────
  1) heap: unconstrained
  ASCII retained/request  ~0 MB  — nursery-collected, negligible
  Mixed retained/request  110 MB  — old-gen, survives to stop-the-world
  Peak heap ratio         36.5×  (mixed vs ASCII)
  Wall time ratio         6.31×  (mixed vs ASCII)

  2) heap: 25MB cap
  ASCII retained/request  ~0 MB  — nursery-collected, negligible
  Mixed retained/request  20 MB  — old-gen, survives to stop-the-world
  Peak heap ratio         7.5×  (mixed vs ASCII)
  Wall time ratio         3.17×  (mixed vs ASCII)


  A 5 MB payload with one emoji forces a UTF-16 string that retains
  more that 36 times the baseline in an unscontrained environment
  and more than 7 times in experimental constrained envorinment
